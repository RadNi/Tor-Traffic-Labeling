...
open(F, "/home/farid/Programming/Tor-Traffic-Labeling/src/or/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/home/farid/Programming/Tor-Traffic-Labeling/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/home/farid/Programming/Tor-Traffic-Labeling/doc/tor.1.txt") or die;
while (<F>) {
