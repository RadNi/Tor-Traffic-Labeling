...
open(F, "/home/user/disk2/git/Tor-gitweb/Tor-gitweb/src/or/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/home/user/disk2/git/Tor-gitweb/Tor-gitweb/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/home/user/disk2/git/Tor-gitweb/Tor-gitweb/doc/tor.1.txt") or die;
while (<F>) {
